package io.github.pagmonet.pagmonet4j.examples;

import io.github.pagmonet.pagmonet4j.*;
import io.github.pagmonet.pagmonet4j.algorithms.*;
import io.github.pagmonet.pagmonet4j.examples.problems.*;

/**
 * Runnable pagmonet4j examples.
 *
 * <p>Teaches both how to use pagmonet4j APIs and why optimization structures
 ...
 * {@code maneuver}, {@code cloning}, {@code kotlin}, {@code all}.
...
public final class Main {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("pagmonet4j runnable examples");
        ...
        switch (scenario) {
            ...
            case "all" -> {
                ...
                System.out.println();
                Scenarios.runOrbitalManeuverOptimization(verbose);
                System.out.println();
