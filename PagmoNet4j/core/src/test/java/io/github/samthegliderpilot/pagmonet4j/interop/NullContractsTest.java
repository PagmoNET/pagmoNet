package io.github.samthegliderpilot.pagmonet4j.interop;

import io.github.samthegliderpilot.pagmonet4j.*;
import io.github.samthegliderpilot.pagmonet4j.algorithms.IAlgorithm;
...
class NullContractsTest {
    ...
    void problemConstructorRejectsNullManagedProblem() {
        assertThrows(NullPointerException.class,
            () -> { try (problem p = new problem((io.github.samthegliderpilot.pagmonet4j.problems.IProblem) null)) {} });
    }
}
