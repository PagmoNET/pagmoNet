package io.github.pagmonet.pagmonet4j.interop;

import io.github.pagmonet.pagmonet4j.*;
import io.github.pagmonet.pagmonet4j.algorithms.IAlgorithm;
...
class NullContractsTest {
    ...
    void problemConstructorRejectsNullManagedProblem() {
        assertThrows(NullPointerException.class,
            () -> { try (problem p = new problem((io.github.pagmonet.pagmonet4j.problems.IProblem) null)) {} });
    }
}
