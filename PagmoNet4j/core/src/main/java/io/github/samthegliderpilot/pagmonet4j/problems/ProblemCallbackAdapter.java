package io.github.samthegliderpilot.pagmonet4j.problems;
 ...
 */
public final class ProblemCallbackAdapter extends ProblemCallback implements DeferredExceptionHolder {

    private final IProblem problem;
    private final AtomicReference<Throwable> deferredEx = new AtomicReference<>();
    ...
    public Throwable consumeDeferredException() {
        return deferredEx.getAndSet(null);
    }

    private void defer(Throwable ex) { deferredEx.compareAndSet(null, ex); }
