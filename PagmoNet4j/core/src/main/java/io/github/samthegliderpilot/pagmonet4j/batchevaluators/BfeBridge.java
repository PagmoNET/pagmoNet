package io.github.samthegliderpilot.pagmonet4j.batchevaluators;
...
public final class BfeBridge {
    ...
    public static DoubleVector batchEvaluate(
        ...
        try {
            long ptr = pagmonet4j.pagmonet_default_bfe_evaluate(
                    problemPtr, NativeInterop.getDoubleVectorPtr(batchX));
            if (ptr == 0) {
                throw new RuntimeException(
                    "pagmonet_default_bfe_evaluate failed: " + pagmonet4j.pagmonet_get_last_error());
            }
