 ...
 * and the pagmonet4j JNI native layer.
 *
...
public final class NativeInterop {
    ...
    public static long createProblemPointer(IProblem problem) {
        ...
        long problemPtr = pagmonet4j.pagmonet_problem_from_callback(cbPtr);
        ...
        if (problemPtr == 0) {
            String nativeErr = pagmonet4j.pagmonet_get_last_error();
            throw new RuntimeException(
    ...
    public static long[] consumeOwnedSizeTVector(SizeTVector v) {
    ...
    public static long createAlgorithmPointer(IAlgorithm algorithm) {
        ...
        long algorithmPtr = pagmonet4j.pagmonet_algorithm_from_callback_java(cbPtr);
        ...
        if (deferred != null) {
            if (algorithmPtr != 0) {
                pagmonet4jJNI.delete_algorithm(algorithmPtr);
