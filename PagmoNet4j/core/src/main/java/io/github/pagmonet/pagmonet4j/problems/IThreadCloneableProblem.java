 ...
 * ({@link io.github.pagmonet.pagmonet4j.ThreadSafety#None}) but can produce
...
public interface IThreadCloneableProblem extends IProblem {
     ...
     * caller will fall back to requiring {@link io.github.pagmonet.pagmonet4j.ThreadSafety#Basic}
