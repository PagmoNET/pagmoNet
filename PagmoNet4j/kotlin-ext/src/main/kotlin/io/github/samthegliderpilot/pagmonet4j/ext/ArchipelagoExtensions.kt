...
/** Sets an unconnected topology on this archipelago and returns it for chaining. */
fun archipelago.withTopology(t: unconnected): archipelago = also { set_topology_unconnected(t) }
