...
public class Test_sea : TestAlgorithmBase
{
    ...
    {
        using var problem = new TwoDimensionalSingleObjectiveProblemWrapper();
        using var algorithm = new pagmo.sea(10u);
        ...
        Assert.That(typedLines.Count, Is.GreaterThan(0), "sea verbosity should produce at least one log line");
        ...
        Assert.That(genericLines[0].AlgorithmName, Is.EqualTo("sea"));
